  ...
  return (
    <div className="container mx-auto px-6 py-12">
      ...
      <FadeIn className="mb-20 flex flex-col md:flex-row justify-between items-start md:items-end border-b border-white/20 pb-12 gap-8">
        <h1 className="text-6xl md:text-9xl font-bold uppercase tracking-tighter">{work.title}</h1>
        <div className="text-left md:text-right">
           <p className="text-gray-500 text-sm uppercase mb-2">Category</p>
           <p className="text-xl md:text-2xl">{work.category}</p>
        </div>
      </FadeIn>

      {/* Banner */}
      <FadeIn delay={0.2} className="relative w-full aspect-video rounded-2xl overflow-hidden mb-32 bg-[#1a1a1a]">
      ...
      <FadeIn delay={0.3} className="grid md:grid-cols-[1fr_2fr] gap-12 mb-32">
        <h3 className="text-2xl font-medium uppercase">About the project</h3>
      ...
      <FadeIn delay={0.4} className="mb-20">
        <div className="flex items-center justify-between mb-12">
          <h3 className="text-4xl md:text-6xl font-bold uppercase tracking-tight">FAQ</h3>
            ...
            <div key={i} className="group border-t border-white/20 py-8 transition-colors hover:bg-white/5 px-4">
              <div className="flex flex-col md:flex-row justify-between md:items-start gap-4">
                ...
                <div className="md:w-1/2">
                  <h4 className="text-xl font-medium uppercase mb-4">{item.question}</h4>
                </div>
